...
class LoginPage(BasePage):
    ...
    def login(self, user: UserDTO) -> HomePage:
        ...
        with self.page.expect_navigation():
            self.fill(self.EMAIL_INPUT, user.email, name="Enter email")
            self.fill(self.PASSWORD_INPUT, user.password, name="Enter password")
    ...
    def assert_sign_in_form_visible(self) -> LoginPage:
        ...
        self.wait_for_visible(self.EMAIL_INPUT, name="Verify email field is visible")
        self.wait_for_visible(self.PASSWORD_INPUT, name="Verify password field is visible")
        self.wait_for_visible(self.SIGN_IN_BUTTON, name="Verify sign-in button is visible")
        return self
    ...
    def assert_login_error_visible(self, *, message: str | None = None) -> LoginPage:
        ...
        error = self.wait_for_visible(
            self.ERROR_MESSAGE,
            name="Verify login error message is visible",
        )
